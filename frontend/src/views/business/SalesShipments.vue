<template>
  <div class="lark-sales">
    <div class="lark-page-header">
      <div class="header-title">销售发货单</div>
      <div class="header-desc">查看 ERP 销售发货单数据</div>
    </div>
    ...
    <div class="lark-table-panel">
      ...
      <div class="lark-toolbar">
        <div class="toolbar-left">
          <el-select v-model="filter.state" placeholder="单据状态" clearable style="width: 120px;" @change="handleSearch">
      ...
      <div class="summary-bar" v-if="total > 0">
        <span class="summary-item">共 <strong>{{ total }}</strong> 条发货单</span>
...
const summaryQty = computed(() => {
  return shipments.value.reduce((s, o) => s + (o.total_qty || 0), 0)
})

const summaryAmount = computed(() => {
  return shipments.value.reduce((s, o) => s + (o.total_amount || 0), 0).toFixed(2)
})
